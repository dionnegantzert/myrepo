...
***
One result that surprised me in this data set was the popularity of the tracks. The dotted lines you see in the graph are the average popularity score per composer. The Star Wars movies composed by Williams are a lot older than the Star Wars series composed by Kiner and Goransson. Therefore, it would be logical to think that more people watched the movies and thus listened to the older songs (i.e. the older songs would be more popular). Apparently, my intuition was wrong about this since most of the songs composed by Williams are not popular at all. In the visualization below you can see that Williams got the highest amount of songs with a popularity of zero. Goransson on the other hand, did a great job with the highest popularity scores. If the popularity of a song is 30 or above, there is a 40/59 chance that it is Goransson, which accounts for 67%. 
...
knitr::include_graphics("confusedfinal2.png") # 0.9166666666666666
```
...
```{r picture5, echo = F, fig.cap = "Fig 2: Star Wars Rebels", out.width = '50%', fig.align='center'}
knitr::include_graphics("rebels.jpg") 
```
